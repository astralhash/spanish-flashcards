...
ok(Core.answerMatches('to work', 'work'), 'matches an English verb gloss without leading "to"');
ok(Core.answerMatches('to be up to date', 'be up to date'), 'strips only the leading infinitive "to"');
ok(Core.answerMatches('work, labor', 'to work'), 'accepts a guess with an extra leading "to"');
ok(!Core.answerMatches('to be up to date', 'up to date'), 'a real missing word still fails');
ok(!Core.answerMatches('to work', 'working'), 'a derived form of the English gloss still fails');
ok(!Core.answerMatches('la toalla', 'alla'), 'a Spanish "to..." word is not split');
